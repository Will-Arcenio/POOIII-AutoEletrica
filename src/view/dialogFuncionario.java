...
public class dialogFuncionario extends javax.swing.JDialog {
    ...
    //Get Object
    private Funcionario getObjeto() {
        return new Funcionario((textId.getText().equals("") ? 0 : Integer.parseInt(textId.getText())),(textNome.getText()), (textEndereco.getText()), (textCpf.getText()), ((Funcao)comboFuncao.getSelectedItem()), ((Cidade)comboCidade.getSelectedItem()), (LocalDate.parse(textDataAdmissao.getText(), formato)), (textTelefone.getText()), (textDataDemissao.getText().equals("  /  /    ") ? null : LocalDate.parse(textDataDemissao.getText(), formato)));
    }
    ...
    public void loadComboFuncao() {
        DefaultComboBoxModel cbm = new DefaultComboBoxModel(daoFuncao.read().toArray());
    ...
    private void fillComponents(Funcionario funcionario) {
        ...
        textDataAdmissao.setText(funcionario.getDataAdmissao().format(formato));
        textDataDemissao.setText(funcionario.getDataDemissao().format(formato));
    ...
    private void initComponents() {
        ...
        textDataDemissao = new javax.swing.JFormattedTextField();
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Pesquisar", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 102, 0))); // NOI18N
        ...
        listFuncionario.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                listFuncionarioMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(listFuncionario);

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(255, 102, 0))); // NOI18N
        ...
        textTelefone.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        ...
        textCpf.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        ...
        textDataAdmissao.setHorizontalAlignment(javax.swing.JTextField.RIGHT);

        jLabel9.setText("Data Demissão:");

        try {
            textDataDemissao.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.MaskFormatter("##/##/####")));
        } catch (java.text.ParseException ex) {
            ex.printStackTrace();
        }
        textDataDemissao.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(textCpf, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(textEndereco, javax.swing.GroupLayout.PREFERRED_SIZE, 323, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                                        .addComponent(comboFuncao, javax.swing.GroupLayout.PREFERRED_SIZE, 403, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(textDataAdmissao, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(textDataDemissao, javax.swing.GroupLayout.PREFERRED_SIZE, 116, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel4Layout.createSequentialGroup()
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel9)
                    .addComponent(textDataDemissao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void listFuncionarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listFuncionarioMouseClicked
        if (evt.getClickCount() == 2) {
            Funcionario funcionario = (Funcionario)listFuncionario.getSelectedValue();
            this.fillComponents(funcionario);
        }
    }//GEN-LAST:event_listFuncionarioMouseClicked
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        if (textNome.getText().trim().isEmpty()) {
            textNome.requestFocus();
            JOptionPane.showMessageDialog(null, "Funcionario obrigatório.");
            return;
        }
        ...
        if (textDataAdmissao.getText().equalsIgnoreCase("  /  /    ")) {
            textDataAdmissao.requestFocus();
            JOptionPane.showMessageDialog(null, "Data de Admissão obrigatória.");
            return;
        }

        try{
            Funcionario funcionario = this.getObjeto();

            if (textId.getText().isEmpty() || textId.getText().equals("0")) {
                daoF.create(funcionario);
                JOptionPane.showMessageDialog(null, "Funcionario cadastrado com sucesso.");
            }else{
                daoF.update(funcionario);
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Confirmar a exclusão do Funcionario?") != 0) {
            return;
        }

        try{
            Funcionario funcionario = (Funcionario)listFuncionario.getSelectedValue();
            daoF.delete(funcionario);
    ...
    private javax.swing.JFormattedTextField textDataDemissao;
